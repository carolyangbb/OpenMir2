...
namespace MirClient.MirGraphics
{
    ...
    public sealed class MLibrary
    {
        ...
        public void Draw(int index, Point point, Color colour, bool offSet, float opacity)
        {
            ...
            rawRectangle.Bottom = mi.Height;
            DXManager.DrawOpaque(mi.Image, rawRectangle, new Vector3(point.X, point.Y, 0.0F), colour, opacity);
            mi.CleanTime = GameFrm.Time + Settings.CleanDelay;
        }
        ...
        public void Draw(int index, SharpDX.Rectangle section, Point point, Color colour, bool offSet)
        {
            ...
            if (section.Right > mi.Width)
                ...
                if (section.Bottom > mi.Height)
                    ...
                    DXManager.Draw(mi.Image, section, new Vector3(point.X, point.Y, 0.0F), colour);
        ...
        public void Draw(int index, Point point, Size size, Color4 colour)
        {
            if (!CheckImage(index))
                return;
    ...
    public sealed class MImage
    {
        ...
        public unsafe void CreateTexture(BinaryReader reader)
        {
            ...
            DataRectangle stream = Image.LockRectangle(0, LockFlags.Discard, out datastream);
            Data = (byte*)stream.DataPointer;
             
            DecompressImage(reader.ReadBytes(Length), datastream);

            stream.DataPointer = datastream.DataPointer;
            ...
            if (HasMask)
            {
                ...
                stream = MaskImage.LockRectangle(0, LockFlags.Discard, out datastream);
                DecompressImage(reader.ReadBytes(Length), datastream);
