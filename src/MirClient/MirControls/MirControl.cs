...
namespace MirClient.MirControls
{
    public class MirControl : IDisposable
    {
        ...
        protected virtual void OnVisibleChanged()
        {
            ...
            else if (IsMouseOver(GameFrm.MPoint))
                Highlight();
        ...
        protected void OnBeforeShown()
        {
            ...
            if (Visible && IsMouseOver(GameFrm.MPoint))
                Highlight();
        ...
        public virtual void OnMouseMove(MouseEventArgs e)
        {
            ...
            if (Moving)
            {
                Point tempPoint = GameFrm.MPoint.Subtract(_movePoint);
            ...
            if (Controls != null)
                for (int i = Controls.Count - 1; i >= 0; i--)
                    if (Controls[i].IsMouseOver(GameFrm.MPoint))
                    {
        ...
        public virtual void OnMouseDown(MouseEventArgs e)
        {
            ...
            {
                Moving = true;
                _movePoint = GameFrm.MPoint.Subtract(Location);
            }
