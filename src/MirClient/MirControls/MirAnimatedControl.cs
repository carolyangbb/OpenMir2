    ...
    public class MirAnimatedControl : MirImageControl
    {
        ...
        public bool Animated
        {
            ...
            set
            {
                ...
                _animated = value;
                _nextOffSet = GameFrm.Time + _fadeInDelay;
        ...
        public bool FadeIn
        {
            ...
            set
            {
                ...
                _nextFadeTime = GameFrm.Time + _fadeInDelay;
                _fadeIn = value;
        ...
        {
            _loop = true;
            _nextFadeTime = GameFrm.Time;
            _nextOffSet = GameFrm.Time;
            Animations.Add(this);
        }

        public void UpdateOffSet()
        {
            if (_fadeIn && GameFrm.Time > _nextFadeTime)
            {
            ...
            if (GameFrm.Time < _nextOffSet) return;

            Redraw();

            _nextOffSet = GameFrm.Time + _animationDelay;
