    ...
    public sealed class MirTextBox : MirControl
    {
        ...
        public MirTextBox()
        {
            ...
            TextBox = new TextBox
            {
                ...
                Font = new System.Drawing.Font(Settings.FontName, 10F * 96f / GameFrm.Graphics.DpiX),
                ForeColor = ForeColour,
                Location = DisplayLocation,
                Size = Size,
                Visible = Visible,
                Tag = this,
                Cursor = GameFrm.Cursors[(byte)MouseCursor.TextPrompt]
            };
            ...
            TextBox.MouseMove += GameFrm.CMain_MouseMove;
        }
