...
namespace MirClient.MirObjects
{
    public class PlayerObject : MapObject
    {
        ...
        public bool RidingMount, Sprint, FastRun, FoundFish;
        ...
        public virtual void SetEffects()
        {
            ...
            //    effect.SetStart(GameFrm.Time + delay);
            //    Effects.Add(effect);
            //}
        ...
        public override void Process()
        {
            ...
            if (this == User)
            {
                if (GameFrm.Time - GameScene.LastRunTime > 899)
        ...
        public virtual void SetAction()
        {
            ...
            if (User == this && GameFrm.Time < MapControl.NextAction)// && CanSetAction)
            {
                //NextMagic = null;
                return;
            }
            ...
            if (ActionFeed.Count == 0)
            {
                ...
                CurrentAction = GameFrm.Time > BlizzardStopTime ? CurrentAction : MirAction.Stance2;
                //CurrentAction = GameFrm.Time > SlashingBurstTime ? CurrentAction : MirAction.Lunge;
                ...
                if (CurrentAction == MirAction.Standing)
                {
                    if (HasClassWeapon)
                        ...
                        CurrentAction = GameFrm.Time > StanceTime ? MirAction.Standing : MirAction.Stance;
                }
            ...
            else
            {
                ...
                switch (CurrentAction)
                {
                    case MirAction.Pushed:
                        if (this == User)
                            MapControl.InputDelay = GameFrm.Time + 500;
                        Frames.TryGetValue(MirAction.Walking, out Frame);
                        break;
                    case MirAction.DashL:
                    case MirAction.DashR:
                    ...
                    case MirAction.Attack1:
                        ...
                        {
                            default:
                                if (GameFrm.Shift && TargetObject == null)
                                    Frames.TryGetValue(GameFrm.Random.Next(100) >= 20 ? MirAction.Attack1 : MirAction.Attack3, out Frame);
                                else
                                    Frames.TryGetValue(CurrentAction, out Frame);
                                break;
                        }
                ...
                //Assassin sneekyness
                if (Sneaking && (CurrentAction == MirAction.Walking || CurrentAction == MirAction.Running))
                {
            ...
            NextMotion2 = GameFrm.Time + EffectFrameInterval;
        ...
        public virtual void ProcessFrames()
        {
            ...
            switch (CurrentAction)
            {
                ...
                case MirAction.DashAttack:
                    ...
                    //if (GameFrm.Time < NextMotion) return;
                    ...
                    if (WingEffect > 0 && GameFrm.Time >= NextMotion2)
                    {
                ...
                case MirAction.Mine:
                    if (GameFrm.Time >= NextMotion)
                    {
                        ...
                        if (UpdateFrame() >= Frame.Count)
                        {
                            ...
                            StanceTime = GameFrm.Time + StanceDelay;
                            FrameIndex = Frame.Count - 1;
                            SetAction();
                        }
                        else
        ...
        public void PlayStruckSound()
        {
            ...
            {
                if (MountType < 7)
                    SoundManager.PlaySound(GameFrm.Random.Next(10179, 10181));
                else if (MountType < 12)
                    SoundManager.PlaySound(GameFrm.Random.Next(10193, 10194));
        ...
        public void PlayAttackSound()
        {
            ...
            {
                if (MountType < 7)
                    SoundManager.PlaySound(GameFrm.Random.Next(10181, 10184));
                else if (MountType < 12)
                    SoundManager.PlaySound(GameFrm.Random.Next(10190, 10193));
