...
namespace GameSvr
{
    ...
    public class ObjectManager
    {
        ...
        /// 精灵对象列表
        /// </summary>
        private readonly ConcurrentDictionary<int, TCreature> _actors = new ConcurrentDictionary<int, TCreature>();
        /// <summary>
        /// 其他对象
        /// </summary>
        private readonly ConcurrentDictionary<int, object> _ohter = new ConcurrentDictionary<int, object>();

        public void Add(int actorId, TCreature actor)
        {
        ...
        public TCreature Get(int actorId)
        {
            TCreature actor = null;
