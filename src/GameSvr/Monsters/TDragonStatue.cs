                    ...
                    for (var i = 0; i < list.Count; i++)
                    {
                        ...
                        if (this.IsProperTarget(cret))
                        {
                            ...
                            if (dam > 0)
                            {
                                ...
                                cret.SendDelayMsg(Grobal2.RM_STRUCK, Grobal2.RM_REFMESSAGE, (short)dam, cret.WAbil.HP, cret.WAbil.MaxHP, this.ActorId, "", 600 + _MAX(Math.Abs(this.CX - cret.CX), Math.Abs(this.CY - cret.CY)) * 50);
                            }
                        }
                    }
                    list.Free();
